...
class customData(Dataset):
    def __init__(self, img_path, txt_path, dataset = '', data_transforms=None, loader = default_loader):
        with open(txt_path) as input_file:
            ...
            self.img_name = [os.path.join(img_path, line.strip().split(' ')[0].__add__('.jpg')) for line in lines]
            self.img_label = [int(line.strip().split(' ')[-1]) for line in lines]
            self.img_label = sort_id(self.img_label)
...
if __name__ == '__main__':
    ...
    image_datasets = {x: customData(img_path=('/home/csc302/bishe/dataset/VehicleID_V1.0/' + x),
                                    txt_path=('/home/csc302/bishe/dataset/VehicleID_V1.0/' + x + '.txt'),
    ...
    # train model
    model_ft, feature_ft = train_model(model=model_ft,
                           criterion=criterion,
    ...
    torch.save(feature_ft, "output/best_resnet_feature.pkl")